...
export function AppRail({ isAuthed, userName }: { isAuthed: boolean; userName?: string }) {
  ...
  return (
    <aside className="sticky top-0 z-40 hidden h-screen w-[60px] shrink-0 flex-col items-center border-r border-black/20 bg-gradient-to-b from-[#4a3d30] to-[#291f17] py-4 text-white md:flex">
      <Link
        href="/"
